...
export default function ResultadoPage() {
      ...
      <div className="min-h-screen bg-[#F0F2F0] flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl p-12 max-w-md text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Volte à página inicial para preencher o formulário e descobrir seu
            impacto.
          </p>
          <button
            onClick={() => router.push("/")}
  ...
  const co2EvitadoNum =
    resultado.co2Evitado ||
    (resultado.gramasCo2Evitados ? resultado.gramasCo2Evitados / 1000 : 0);
  ...
  const minutosEconomizados = resultado.tempoGanhoSegundos
    ? Math.round(resultado.tempoGanhoSegundos / 60)
    : 0;
          ...
          <div className="flex-1 p-10 lg:p-16 flex flex-col justify-between">
            <div>
              ...
              <p className="anim-fade-up text-gray-500 text-sm md:text-base max-w-md leading-relaxed">
                A Taggy ajuda motoristas e empresas a planejar, gerenciar e
                escalar sua eficiência, trazendo clareza e estrutura para a
                economia de pedágios e redução de carbono.
              </p>
            </div>
          ...
          <div className="flex-1 bg-[#F9FBF9] p-6 lg:p-10 flex flex-col justify-center gap-4 border-l border-emerald-50">
            ...
            <div className="anim-card bg-white rounded-2xl p-6 border border-emerald-50 flex items-center justify-between shadow-sm">
              <div className="pr-4">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Gases não emitidos na atmosfera pelo sistema automático.
                </p>
              ...
              <div className="w-32 h-32 rounded-xl bg-gray-100 overflow-hidden shrink-0 hidden sm:block">
                <img
                  src="https://images.unsplash.com/photo-1466611653911-95081537e5b7?q=80&w=400&auto=format&fit=crop"
                  alt="Nature"
            ...
            <div className="anim-card bg-emerald-600 rounded-2xl p-6 shadow-md text-white relative overflow-hidden flex items-center justify-between">
              <div className="relative z-10 w-full">
                ...
                <p className="text-sm text-emerald-100/90 mb-4 max-w-[80%]">
                  Volume de absorção natural equivalente às emissões evitadas na
                  atmosfera.
                </p>
            ...
            <div className="anim-card bg-white rounded-2xl p-6 border border-emerald-50 flex items-center justify-between shadow-sm">
              <div className="pr-4 w-full">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Eficiência de tempo e economia de recursos físicos diários.
                </p>
